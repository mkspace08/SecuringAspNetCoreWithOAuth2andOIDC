...
- Create Angular project with ng: `ng new imagegallery.bff.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`imagegallery.bff.client.esproj`).
