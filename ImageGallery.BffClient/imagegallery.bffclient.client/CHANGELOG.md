...
- Create Angular project with ng: `ng new imagegallery.bffclient.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`imagegallery.bffclient.client.esproj`).
